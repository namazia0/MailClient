...
public class Muell extends Thread {
    /**
     ...
     * */
    public Muell(Mail tempMail2, String gmailBefehl2) {
 ...
 * Sie verschiebt die übergebene Mail in den als Parameter übergebenen Ordner "Papierkorb"
        ...
        try {
            ...
            for (Message tempMessage : temp2) {
                ...
                if (mail.eingangsdatum.equals(tempMail.eingangsdatum) && mail.betreff.equals(tempMail.betreff) && tempMail.sender.equals(mail.sender)) {
                    ...
                    System.out.println("Mail ist identisch und wird gelöscht-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-.-");
                    msgs[0] = tempMessage;
                    Folder archiv = store.getFolder("[Gmail]/Papierkorb");
